...
export default function Toolbar({
  ...
  return (
    <>
      <div
        className="box-border flex max-w-[1100px] flex-wrap items-center gap-1 overflow-hidden overflow-x-scroll
     overflow-ellipsis whitespace-nowrap border-l-0 border-r-0 border-t-0 border-solid border-zinc-200 bg-white p-2 text-left dark:border-zinc-800 dark:bg-neutral-900 "
      >
        {records.at(-1)}
      </div>
      <div className="z-2 sticky top-0 box-border flex flex-wrap items-center gap-1 border-l-0 border-r-0 border-t-0 border-solid border-zinc-200 bg-white p-2 dark:border-zinc-800 dark:bg-neutral-900 ">
        <Toggle
          pressed={false}
