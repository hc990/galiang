    ...
    <>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="relative flex flex-col overflow-scroll rounded-lg  bg-clip-border text-gray-500 shadow-md">
          <table className="">
            <thead>
              <tr className="border-b border-pink-300 bg-pink-50 text-slate-500">
                <th className="border-r-2 border-solid border-pink-200 px-4 py-1">
                  <p className="text-sm font-normal leading-none">材料名称</p>
                </th>
                ...
                <th className="border-r-2 border-solid border-pink-200 px-4 py-2">
                  <p className="text-sm font-normal leading-none">渠道</p>
                </th>
                <th className="border-r-2 border-solid border-pink-200 px-4 py-2">
                  <p className="text-sm font-normal leading-none">备注描述</p>
                </th>
                <th className="border-r-2 border-solid border-pink-200 px-2 py-4">
                  <p>操作</p>
                </th>
              </tr>
            </thead>
